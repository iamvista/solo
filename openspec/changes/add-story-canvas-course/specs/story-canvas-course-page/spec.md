...
### Requirement: 課綱以骨架卡的五欄為骨幹

課綱 SHALL 對應《一人公司的故事骨架卡》的五個欄位：對象切片、轉折點、定位句骨架、證據欄、轉述測試。課綱 MUST 說明每一欄現場要產出什麼，而非只列出欄位名稱。

轉述測試 MUST 被呈現為整堂課的驗收判準，而非最後一個步驟。

#### Scenario: 讀者比對課綱與手上的骨架卡

- **WHEN** 已下載骨架卡的讀者閱讀課綱
- **THEN** 課綱的五個段落與卡片的五欄一一對應，讀者辨認得出這堂課是把手上那張卡帶著做完

#### Scenario: 課綱說明現場產出

- **WHEN** 讀者閱讀任一課綱段落
- **THEN** 該段說明現場會完成什麼具體動作，且至少一段明確寫出「唸給素不相識的人聽、由對方複述」這個現場環節
