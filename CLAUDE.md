...
5. 若採「**先揭露、後開賣**」（招生頁先露出下一梯日期與價格，但 `open` 仍留在前一梯），
   MUST 同時建一筆**切換日的行事曆提醒**，描述欄寫死要改哪些檔案與哪些 Recur 商品。
   `open` 旗標沒有時間概念，過了開課日不會自己關；忘了切，網站會繼續販售一場已經上完的課，
   而且因為下一梯的資訊看起來正常，從畫面上看不出壞掉。

第 4 項是 2026-08-15 補的，第 5 項是 2026-08-24 開 ai-academic-writing 第三期時補的。當天早上晨間簡報才發現 Vibe Coding 第 8 班排在 `workshops.ts` 與 Recur 裡、行事曆卻空白，等於系統認為有課、人不知道。管家的晨間簡報只查行事曆，行事曆沒有的課就不會被提醒，開課日當天才發現已經來不及。
