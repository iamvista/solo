...
export const metadata: Metadata = {
  ...
  description:
    "Susie Li 親授・3 小時實戰。給「什麼都會、卻選不出一個自己」的人：用六步收斂法狠下心收斂成一個記得住、又能變現的定位。第二期 2026/10/24（六）線上開課，開放報名中。",
  openGraph: {
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  ...
                  <div className="space-y-3 text-base">
                    <div className="flex items-center gap-2">
                      <span>📅</span>
                      <span className="font-medium">第二期｜2026/10/24（六）</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span>🕘</span>
                      <span>臺灣時間 09:00 – 12:00（3 小時）</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span>📍</span>
