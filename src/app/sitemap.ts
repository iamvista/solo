...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/books`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/books/vibe-coding`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/books/company-of-none`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
