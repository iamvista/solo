...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "個人定位卡和寫作風格檔案 是 10 份文件中門檻最高、最多人不知道怎麼開頭的兩份。先完成這兩份，你就已經有能力繼續延伸出後面的八份脈絡文件。如果你希望有人陪你把整套建立起來，可以參考頁面下方的進階版顧問服務。",
  },
  {
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="border-l-4 border-primary bg-stone-50 p-8 sm:p-10">
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-stone-600">
              <p>
                AI 不知道你的受眾是誰，不知道你真正想服務的人，也不知道哪些題目你想深耕、哪些領域你根本不想碰。於是，它只能把你當成一個普通的知識工作者，用一種看起來正確、其實沒有靈魂的方式替你寫作。這不是 prompt 的問題，而是上下文的問題。
              </p>
              <p>
                如 AI Operator 等海外社群，很流行一種 context-first 的工作法：與其每次都重新修 prompt，不如先把自己的商業定位、產品、受眾、語氣、知識資產與工作流程，整理成一套 AI 可以長期讀取的脈絡文件。
              </p>
              <p>
                我很認同這個方向。但我也發現，許多海外案例主要服務於 SaaS、電商或強銷售漏斗型的 internet business owner；對華語世界的<span className="font-bold text-stone-900">知識工作者、講師、顧問、作者與獨立創作者</span>來說，我們真正需要的不是更重的 funnel，而是一套能保存思想脈絡、研究積累、寫作風格與內容資產的個人脈絡庫。
              </p>
              <p>
                ...
                。在此，我先開放個人定位卡、寫作風格檔案等兩份免費模板，這是 10 份裡面門檻最高、最多人不知道怎麼開頭的兩份。
              </p>
              <p>
                這兩份不是寫給人看的自我介紹，而是寫給 AI 讀的工作底稿。當 AI 在每次協作時能參照這兩份文件，它就有更高機率從原本的泛用助理，更接近一個懂你脈絡的協作夥伴。
              </p>
            </div>
          </div>
        </div>
