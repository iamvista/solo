  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
      ...
      <div className="mt-8 space-y-8">
        <p className="text-base text-muted-foreground">最後更新日期：2026 年 2 月</p>
        ...
        <section>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            本平臺及其內容（包括但不限於文字、圖片、標誌、設計、軟體、診斷工具）均受著作權及其他智慧財產權法律保護。未經我們書面許可，您不得複製、修改、散佈、銷售或以其他方式使用這些內容。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            您在本平臺上提交或發布的內容（包括診斷回答、評論等），您保留其所有權。但您授予我們非專屬、全球性、免授權費的許可，使用、複製、修改及展示這些內容，以便提供及改善我們的服務。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            本平臺提供的 Solo 類型診斷僅供參考及自我探索之用，不構成專業的職業諮詢、心理評估或醫療建議。診斷結果不應作為重大人生決策的唯一依據。如需專業建議，請諮詢相關領域的專業人士。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            本平臺及其服務按「現狀」提供。我們不對服務的準確性、完整性、可靠性或適用性作任何明示或暗示的保證。在法律允許的最大範圍內，我們不對因使用本平臺而產生的任何直接、間接、附帶、特殊或後果性損害負責。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            在法律允許的範圍內，本平臺對您的總責任不超過您在過去 12 個月內支付給我們的金額，或新臺幣 1,000 元（以較高者為準）。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            我們可能會不時修改本服務條款。重大變更將透過平臺公告或電子郵件通知。繼續使用服務即表示接受修改後的條款。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            本條款受中華民國法律管轄。因本條款產生的任何爭議，雙方同意以臺灣臺北地方法院為第一審管轄法院。
          </p>
        </section>
