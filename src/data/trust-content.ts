export interface TrustSection {
	/** 這一節覆蓋了 vista-official-site/data/trust-claims.json 的哪些主張。文案不受它影響，只供 check-trust-claims.mjs 檢查有沒有漏講。 */
	claims?: string[];
  title: string;
  paragraphs: string[];
  items?: string[];
...
export const trustPages: Record<TrustPageContent["slug"], TrustPageContent> = {
  ...
  intro: "solo.tw 以可實踐、可追溯、清楚揭露為原則，將經驗與資料整理成一人事業經營者能採取行動的內容。",
  sections: [
    {
      title: "我們如何選題",
  ...
  related: [{ href: "/editorial-policy", label: "查看編輯與更正政策" }],
  },
  ...
  intro: "我們對發布內容負責，清楚區分編輯判斷與商業合作，並在錯誤影響讀者理解或決策時儘速更正。",
  sections: [
    {
      title: "編輯獨立性",
