        ...
        <div className="text-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="ml-2 text-sm text-muted-foreground">4.9/5 好評推薦</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {[
              ...
              <div
                key={type.name}
                className="flex items-center gap-2 rounded-full border bg-background px-4 py-2 shadow-sm transition-all hover:border-primary/50 hover:shadow-md"
              >
