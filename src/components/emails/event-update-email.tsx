...
const tag = { color: "#6366f1", fontSize: "13px", fontWeight: "600" as const, margin: "0 0 8px" };
const h1 = { color: "#1a1a1a", fontSize: "22px", fontWeight: "bold" as const, margin: "0 0 20px" };
