...
export function LecturerKitPurchaseEmail({
  productName,
  downloadUrl,
  orderNumber,
  amountFormatted,
  ...
  return (
    <Html>
      <Head />
      <Preview>感謝購買{productName}：點此下載你的講師幕僚</Preview>
      <Body style={main}>
        <Container style={container}>
          <Text style={tag}>🎉 付款成功</Text>
          <Heading style={h1}>感謝購買{productName}</Heading>
          <Text style={subtext}>
            哈囉，感謝你購買{productName}。以下是你的下載頁連結，請在 {expiresInHours} 小時內完成下載。
          </Text>
