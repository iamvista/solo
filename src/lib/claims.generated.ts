...
// registry revision: 2026-09-04-01

export interface Claim { value: string; label: string; exact: number | string; kind: string; }

export const claims: Record<string, Claim> = {
	"verified_sessions": { value: "213 場以上", label: "可查證授課場次", exact: 213, kind: "floor" },
	"partner_orgs": { value: "123 個以上", label: "合作單位", exact: 123, kind: "floor" },
...
export const REGISTRY_REVISION = "2026-09-04-01";
