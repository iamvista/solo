...
export const workshops: Workshop[] = [
  ...
  },
  {
    ...
    description:
      "給研究生、博士生、大學教師與研究員：用 AI Agent 當你的研究副駕駛，跑通文獻回顧、論文架構、學術英文潤稿與寫作效率工作流。強調 AI 輔助而非代寫，核心思考與洞察仍來自你自己，含學術倫理與 AI 揭露原則。3 小時帶走一套可複用的個人 AI 學術工作流。",
    instructor: vista,
    emoji: "🎓",
