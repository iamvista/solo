...
export const workshops: Workshop[] = [
  {
    ...
    // 2026-08-12 二次改版：從一日課改為半日的「設計篇」，並拆成系列。
    // 理由：一日課 8,800 要靠廣告賣冷流量，臺灣市場的 CAC 撐不住；改成
    // 半日 5,800 降低報名門檻與期待落差，施工篇（AI agent 實際搭建）改走
    // 名單轉換、不投廣告。施工篇的日期與定價都還沒定，頁面只放預告與
    // 意願調查，不標價。一日版的最後狀態保留在 git tag solo-company-fullday-v1。
    ...
    id: "solo-company",
    title: "無人公司工作坊．設計篇",
    subtitle: "先想清楚，你的公司該把哪些事交出去",
    description:
      "給案子接得到、客戶回得完，卻每一件都得自己碰一次的人。不是 AI 工具課，是用 AI 當執行力的經營課。半天、六次動手，帶走一位當場驗收過的 AI 員工、一張畫出瓶頸的工作地圖與一份九十天路線圖。不綁工具，免費版就能做完。創始梯次價 NT$5,800（正式價 7,800），限 20 名。",
    instructor: vista,
    emoji: "🏗️",
    date: "尚未公告，留信箱通知你",
    sortDate: "9999-12-31",
    ...
    isExternal: false,
    highlights: [
      "半天六次動手，下課前那位 AI 員工已經上工並交過一次東西",
      "核心是六欄設定卡與五問篩子：把腦子裡的判斷寫成別人接得住的標準",
      "含三道護欄與上線前檢查表，不是只教油門不教煞車",
      "不綁任何一家工具，免費版就能做完，不必訂閱",
      "創始梯次價 NT$5,800（正式價 7,800）・限 20 名・日後回訓只收 NT$1,000",
    ],
    category: "ai",
  },
  {
